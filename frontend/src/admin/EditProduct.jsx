...
const EditProduct = () => {
  ...
  return (
    <div style={{ maxWidth: '600px', margin: '40px auto', background: '#FFFFFF', padding: '40px', borderRadius: '12px', border: '1px solid rgba(0,121,107,0.16)' }}>
      <h2 style={{ color: '#4CAF50', marginBottom: '20px' }}>Edit Product</h2>
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
        ...
        <div style={{ padding: '15px', border: '1px dashed #4CAF50', borderRadius: '8px' }}>
          <label style={{ display: 'block', marginBottom: '10px', color: '#00796B' }}>Replace Image (Optional)</label>
          <input type="file" accept="image/*" onChange={(e) => setImage(e.target.files[0])} style={{ color: '#00796B' }} />
        </div>
...
const inputStyle = { padding: '12px', background: '#E0F7FA', border: '1px solid rgba(0,121,107,0.16)', borderRadius: '6px', color: '#00796B', fontSize: '15px', outline: 'none' };
